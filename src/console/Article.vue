        ...
        <div class="panel mb-4 bg-light p-2 rounded-sm">
            ...
            <template v-if="state.mode == 'draft'">
                <div class="panel-head flex items-center justify-between  h-10 border-b-solid border-b border-gray-200">
                    ...
                    <div class="p-2 bg-green-400 text-light-50 rounded cursor-pointer" @click="saveDraft">保存草稿(Ctrl+S)</div>
                </div>
                <div class="panel-body pt-2">
                    <form class="flex flex-col gap-4">
                        ...
                        <div class="setting bg-light-50 p-1">
                            ...
                            <div class="metadata">
                                ...
                                <div class="keywords">
                                    <div class="label">SEO标签</div>
                                    <div class="flex gap-1">
                                        <template v-for="(item,index) in state.draft.keywords" :key="index">
                                            <div class="border-1 rounded p-1">
                                                <span>{{ item }}</span>
                                                <span @click="deleteKeyword" :data-index="index">x</span>
                                            </div>
                                        </template>
                                        <div>
                                            <input type="text" @change="keywordChange">
                                        </div>
                                    </div>
                                </div>
                                <div class="description">
                                    ...
                                    class="border-1 p-2 h-10 truncate resize-none"
...
const keywordChange = (e)=>{
    let {value} = e.target;
    state.draft.keywords.push(value);
    e.target.value = ''
